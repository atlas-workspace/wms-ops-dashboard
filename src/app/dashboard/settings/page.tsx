    ...
    <div className="space-y-4">
      ...
      <div className="bg-white rounded-xl shadow-sm border border-gray-100 p-5 space-y-4">
        ...
        <div className="space-y-2">
          ...
          <IntegrationRow name="UNIS Ticket System" url="unisticket.item.com" status="connected" />
          <IntegrationRow name="Paylocity" url={`Company ${PAYLOCITY_COMPANY_ID}`} status="pending" />
        </div>
      </div>
      ...
      <div className="bg-white rounded-xl shadow-sm border border-gray-100 p-5 space-y-4">
        <div className="flex items-center justify-between">
          <h2 className="text-sm font-semibold text-gray-800">Paylocity Configuration</h2>
        ...
        <div className="grid grid-cols-2 gap-4">
          <div>
            ...
            <input type="text" value={PAYLOCITY_COMPANY_ID} readOnly className="w-full border border-gray-200 rounded px-3 py-2 text-sm text-gray-800 bg-gray-50 font-mono" />
          </div>
          <div>
            ...
            <a
              ...
              className="flex items-center gap-1 w-full border border-gray-200 rounded px-3 py-2 text-sm text-[#0066a1] hover:bg-gray-50 transition-colors"
            >
              Open Paylocity Portal
        ...
        <div className="p-3 bg-gray-50 rounded-lg">
          <p className="text-xs text-gray-600">
            To enable automatic employee sync from Paylocity, set <code className="text-[10px] bg-gray-200 px-1 rounded">PAYLOCITY_CLIENT_ID</code> and <code className="text-[10px] bg-gray-200 px-1 rounded">PAYLOCITY_CLIENT_SECRET</code> environment
            variables. Obtain credentials from the{" "}
            <a href="https://developers.paylocity.com/" target="_blank" rel="noopener noreferrer" className="text-[#0066a1] hover:underline">
